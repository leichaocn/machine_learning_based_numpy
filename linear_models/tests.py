...
from linear_models.lm import RidgeRegression
from linear_models.lm import LinearRegression
from linear_models.lm import BayesianLinearRegressionKnownVariance
from linear_models.lm import BayesianLinearRegressionUnknownVariance
from linear_models.lm import LogisticRegression

from utils.com_func import show
#######################################################################
#                           Data Generators                           #
#######################################################################
...
def plot_logistic():
    ...
    for i, ax in enumerate(axes.flatten()):
        n_in = 1
        n_ex = 150
        # 生成150个样本，每个样本的X是1维特征，即1个值，y也是一个值，即1或-1
